(function (name, factory) {
  ...
  Factory.prototype = {
    ...
    init: function () {
      try {
        ...
        var pr = window.devicePixelRatio || 1;  //获取当前显示设备的物理像素分辨率与 CSS 像素分辨率的比率
    ...
    addRibbon: function () {
      ...
      var dir = Math.round(random(1, 9)) > 5 ? "right" : "left",
        ...
        starty = (window.innerHeight * 0.7 - 90) + (random() * 2 - 1.1) * 90;
    ...
    _drawRibbonSection: function (section) {
      if (section) {
        ...
        // this._context.lineTo(0, window.innerHeight * 0.7 - 90);
        // var k = 0 + (random()*2-0.25)*90, n = line(window.innerHeight * 0.7 - 90);
        // this._context.lineTo(k,n);
  ...
  function line(p){
    var t = p + (random() * 2 - 1.1) * 90;
    return (t > window.innerHeight || t < 0) ? line(p) : t;
  }
